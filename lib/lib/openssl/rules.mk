...
# Not compiling openssl with -Werror
MODULE_CFLAGS += -Wno-error -Wno-unused-function -Wno-unused-parameter

ifeq ($(MOVE_TOS_SECRETS_TO_DEV_MEMORY),1)
MODULE_CFLAGS += -DNO_UNALIGNED_ACCESS
endif
